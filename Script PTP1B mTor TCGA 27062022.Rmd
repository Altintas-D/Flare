...
```{r}
ptp50 <- read.table("https://raw.githubusercontent.com/Altintas-D/Flare/Tables/ptpn50.txt", dec=".", header=T, sep="\t")
ptp352 <- read.table("https://raw.githubusercontent.com/Altintas-D/Flare/Tables/ptpn352.txt", dec=".", header=T, sep="\t")
ptp378 <- read.table("https://raw.githubusercontent.com/Altintas-D/Flare/Tables/ptpn378.txt", dec=".", header=T, sep="\t")
